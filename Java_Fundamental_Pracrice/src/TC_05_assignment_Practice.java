...
public class TC_05_assignment_Practice {
	...
	public static void main(String[] args) {
		...
		//Variable assignment
		int speed = 80;
		// speed variable gets the value 80
		int distance = 20; 
		// distance variable gets the value 20
		int time = 10; 
		// time variable gets the value 10
		String name = "ToolsQA";
		// name variable gets the value ToolsQA
		boolean isGood = true;
		// isGood variable gets the value true
